-- ============================================================================
-- Migration: Update leave_plan and remove_participant RPCs to order by joined_queue_at ASC
-- Description: Ensures all Automatic waitlist promotions strictly use joined_queue_at ASC
--              with created_at ASC as tiebreaker.
-- ============================================================================
