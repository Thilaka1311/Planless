-- Migration: Allow disabling auto-promotion in update_plan_capacity for Assigned mode
-- Description: Adds optional p_auto_promote boolean parameter (default true).
-- When adding or moving a specific participant in Assigned mode, p_auto_promote = false
-- prevents auto_promote_waitlist_for_assigned from promoting existing waitlisted participants.
