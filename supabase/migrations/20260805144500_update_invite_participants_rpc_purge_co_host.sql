-- Migration: Purge stale CO_HOST reference from invite_participants RPC
-- Description: Updates public.invite_participants to check v_caller_role = 'HOST'::participant_role
