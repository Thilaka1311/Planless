-- Migration: Fix 24-hour participant management window for completed plans (Correct enum cast)
-- Description: Applies manage_completed_plan_participants RPC with 24-hour window check and correct PARTICIPANT::participant_role enum cast.
