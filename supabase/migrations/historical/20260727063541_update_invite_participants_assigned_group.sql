-- Migration: Update invite_participants RPC to accept p_assigned_group parameter
-- Description: Sets assigned_group (GOING vs WAITLIST vs NULL) when adding or re-inviting participants.
