-- Migration: Fix complete_plan attendance precedence and final state invariant
-- Description: Ensures Host Attendance selection is the single source of truth during complete_plan.
-- Attended participants (regardless of initial RSVP) -> final_attendance = 'ATTENDED', final_state = 'JOINED', rsvp_status = 'JOINED', skip_reason = NULL.
-- Unattended participants -> final_attendance = 'DID_NOT_ATTEND', final_state = 'SKIPPED', rsvp_status = 'SKIPPED'.
