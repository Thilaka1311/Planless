-- Migration: 20260828115000_fix_replace_participant_enum_skip_reason.sql
-- Description: Fix 400 Bad Request error caused by invalid enum cast 'SKIPPED'::skip_reason. The rsvp_status is 'SKIPPED'::rsvp_status and skip_reason is 'REPLACED'::skip_reason.
...
-- 2. UPDATE resolve_paid_plan_leave_request RPC WITH REPLACED skip_reason
