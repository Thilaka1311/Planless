-- Migration: Clear Wallet Obligation When a Participant Is Removed
-- Description: Updates remove_participant RPC to automatically invoke recalculate_wallet_expenses(p_plan_id),
--              atomically deleting any unsettled wallet obligation for the removed participant and recalculating plan fee obligations.
...
BEGIN
  ...
  -- 8. Recalculate wallet expenses atomically in the same transaction
