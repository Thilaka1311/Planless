-- Migration: 20260906140000_delete_invited_participant_on_removal.sql
-- Description: Updates remove_participant RPC so that when a host removes an INVITED participant,
--              their plan_participants row is deleted rather than marked as SKIPPED.
