-- Migration: 20260828114500_fix_replace_participant_found_variable_bug.sql
-- Description: Fix PL/pgSQL FOUND variable bug in replace_participant and resolve_paid_plan_leave_request where intermediate UPDATE target_user statement overwrote FOUND before checking if replacement_user existed, causing new friends to never be inserted into plan_participants.
...
-- 2. UPDATE resolve_paid_plan_leave_request RPC WITH EXPLICIT FOUND VARIABLE
