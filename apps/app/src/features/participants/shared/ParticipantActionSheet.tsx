          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            {onPromoteHost && isJoinedRsvpParticipant(selectedItem) && !selectedItem.isHost && (
              <button
                ...
                style={{ width: '100%', padding: '14px', background: 'rgba(245,158,11,0.08)', border: 'none', borderRadius: 12, color: '#FFFFFF', fontSize: 14, fontWeight: 600, cursor: 'pointer', textAlign: 'left' }}
              >
                Make Host
              </button>
            )}
